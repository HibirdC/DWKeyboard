...
class DWKEYBOARDSHARED_EXPORT PlatformInputContext : public QObject
{
    Q_OBJECT
public:
...
private slots:
	...
	bool virtualKeyPress(Qt::Key key, const QString &text, Qt::KeyboardModifiers modifiers, bool isAutoRepeat);// 控件点击
	bool virtualKeyRelease(Qt::Key key, const QString &text, Qt::KeyboardModifiers modifiers);// 控件点击
private:
