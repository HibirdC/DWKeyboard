...
namespace QtVirtualKeyboard {
	...
	QWidget(parent)
	{
        ...
        m_btnbackgroundClr = QColor(11, 41, 93);         // 按钮背景颜色
        m_btnHoverClr = QColor(240, 240, 240);           // 按钮hover颜色
        m_btnPressedClr = QColor(0, 204, 107);           // 按钮按钮颜色
        m_btnTxtClr = QColor(253, 215, 26);			 // 按钮字体颜色
        m_btnTxtHoverClr = QColor(0, 0, 0);
        m_btnTxtPressClr = QColor(255, 255, 255);
        m_HanziClr = QColor(0, 0, 0);                    // 汉字背景颜色
        m_HanziHoverClr = QColor(254, 39, 46);           // 汉字hover颜色
        m_HanziPressedClr = QColor(0, 204, 107);         // 汉字按下颜色
        m_HanziTxtClr = QColor(255, 255, 255);			 // 汉字字体颜色
		m_HanziPressTxtClr = QColor(255, 255, 240);      // 汉字字体颜色

    main_object = main;
    m_ViewMode = ViewABC;//ViewABC;
...
//        QString str = QString("QWidget{background:%1;border-image:url(:/QtQuick/VirtualKeyboard/content/styles/default/images/keyboardBg.png); border:1px solid #00C2EB; border-radius:2px;}\
...
//                              QPushButton{background:%9; color:%10; border:1px solid #0FF5F9; border-radius:3px; padding:10% 10% 10% 10%;} \
//                              QPushButton:hover{ background:%11; color:%12;}	 \
//                              QPushButton:pressed{ background:%13; color:%14;}")//0FF5F9  353535
...
//                              .arg(toRGB(m_btnTxtHoverClr))
//                              .arg(toRGB(m_btnPressedClr))
//                              .arg(toRGB(m_btnTxtPressClr));
    QString str = QString("QWidget{background-image:url(:/QtQuick/VirtualKeyboard/content/styles/default/images/keyboardBg.png); border:1px solid #00C2EB; border-radius:2px;}\
                          QListWidget{background-image:url(:/QtQuick/VirtualKeyboard/content/styles/default/images/keyboardBg.png); border: 0px; margin-left:1px; margin-right:1px;margin-top:1px; padding-left:0 px ;padding-right:0 px;}\
                          QListWidget::item{color:%1; padding-left: 3%; padding-right: 3%;}\
                          QListWidget::Item:hover{; }\
                          QListWidget::item:selected{color:%2; }\
                          QListWidget::item:selected:!active{border-width:0px; background:%3; }\
                          QPushButton{background-image:url(:/QtQuick/VirtualKeyboard/content/styles/default/images/BtnBg.png); color:%4; border:1px solid #0FF5F9; border-radius:3px; padding:10% 10% 10% 10%;} \
                          QPushButton:hover{ background:%5; color:%6;}	 \
                          QPushButton:pressed{ background:%7; color:%8;}")//0FF5F9  353535 .arg(toRGB(m_HanziClr))
                          .arg(toRGB(m_HanziTxtClr))
                          .arg(toRGB(m_HanziPressTxtClr))
                          .arg(toRGB(m_HanziPressedClr))
                          .arg(toRGB(m_btnTxtClr))
...
QString InputDialogView::GetShowText(int key, bool bshift, bool bcaplock, InputEngine::InputMode mode)
{
    ...
    case Qt::Key_Space:
        switch (mode)
        {
        case InputEngine::Latin:	return QStringLiteral("");break;// 切换语言键
        case InputEngine::Pinyin:	return QStringLiteral("简体中文");break;// 切换语言键
        }
        break;
    case Qt::Key_Ampersand :	return QStringLiteral("&&");break;
    case Qt::Key_Apostrophe :	return QStringLiteral("‘");break;
    case Key_ApostropheRight :	return QStringLiteral("’");break;
    case Qt::Key_QuoteDbl :		return QStringLiteral("“");break;
    case Key_QuoteDblRight :	return QStringLiteral("”");break;
    default:
...
QString InputDialogView::GetValueText(int key, bool bshift, bool bcaplock, InputEngine::InputMode mode)
{
    ...
    //////////////////////////////////////////////////////////////////////////
    case Qt::Key_QuoteLeft :return bEn ? QStringLiteral("·") : QStringLiteral("、");break;
    case Qt::Key_AsciiTilde:return bEn ? QStringLiteral("~") : QStringLiteral("～");break;
    case Qt::Key_Exclam		:return bEn ? QStringLiteral("!") : QStringLiteral("！");break;
    case Qt::Key_At :return bEn ? QStringLiteral("@") : QStringLiteral("@");break;
    case Qt::Key_NumberSign :return bEn ? QStringLiteral("#") : QStringLiteral("#");break;
    case Qt::Key_Dollar :return bEn ? QStringLiteral("$") : QStringLiteral("￥");break;
    case Qt::Key_Percent  :return bEn ? QStringLiteral("%") : QStringLiteral("%");break;
    case Qt::Key_AsciiCircum :return bEn ? QStringLiteral("^") : QStringLiteral("…");break;
    case Qt::Key_Ampersand :return bEn ? QStringLiteral("&") : QStringLiteral("&");break;
    case Qt::Key_Asterisk :return bEn ? QStringLiteral("*") : QStringLiteral("*");break;
    case Qt::Key_Equal :return bEn ? QStringLiteral("=") : QStringLiteral("=");break;
    case Qt::Key_Underscore :return bEn ? QStringLiteral("_") : QStringLiteral("—");break;

    case Qt::Key_Semicolon :return bEn ? QStringLiteral(";") : QStringLiteral("；");break;
    case Qt::Key_Colon :return bEn ? QStringLiteral(":") : QStringLiteral("：");break;
    case Qt::Key_Comma :return bEn ? QStringLiteral(",") : QStringLiteral("，");break;	// 逗号
    case Qt::Key_Period  :return bEn ? QStringLiteral(".") : QStringLiteral("。");break;	// 句号
    case Qt::Key_Slash :return bEn ? QStringLiteral("/") : QStringLiteral("/");break;
    case Qt::Key_Bar :return bEn ? QStringLiteral("|") : QStringLiteral("|");break;
    case Qt::Key_Backslash :return bEn ? QStringLiteral("\\") : QStringLiteral("、");
    case Qt::Key_Question :return bEn ? QStringLiteral("?") : QStringLiteral("？");break;	// 问号
    // 加减乘除键
    case Qt::Key_Plus :return bEn ? QStringLiteral("+") : QStringLiteral("+");break;
    case Qt::Key_Minus :return bEn ? QStringLiteral("-") : QStringLiteral("-");break;
    case Qt::Key_division: return bEn ? QStringLiteral("÷") : QStringLiteral("÷");break;
    case Qt::Key_multiply: return bEn ? QStringLiteral("×") : QStringLiteral("×");break;
    //一对键
    case Qt::Key_ParenLeft  :return bEn ? QStringLiteral("(") : QStringLiteral("（");break;
    case Qt::Key_ParenRight :return bEn ? QStringLiteral(")") : QStringLiteral("）");break;
    case Qt::Key_BracketLeft  :return bEn ? QStringLiteral("[") : QStringLiteral("【");break;
    case Qt::Key_BracketRight :return bEn ? QStringLiteral("]") : QStringLiteral("】");break;
    case Qt::Key_BraceLeft :return bEn ? QStringLiteral("{") : QStringLiteral("『");break;
    case Qt::Key_BraceRight :return bEn ? QStringLiteral("}") : QStringLiteral("』");break;
    case Qt::Key_Less :return bEn ? QStringLiteral("<") : QStringLiteral("《");break;
    case Qt::Key_Greater  :return bEn ? QStringLiteral(">") : QStringLiteral("》");break;
    case Qt::Key_Apostrophe :return bEn ? QStringLiteral("'") : QStringLiteral("‘");break;
    case Key_ApostropheRight :return bEn ? QStringLiteral("'") : QStringLiteral("’");break;
    case Qt::Key_QuoteDbl :return bEn ? QStringLiteral("\"") : QStringLiteral("“");break;
    case Key_QuoteDblRight :return bEn ? QStringLiteral("\"") : QStringLiteral("”");break;
    //////////////////////////////////////////////////////////////////////////
    // 控制键
    case Key_Pager:
        switch (m_ViewMode)
    ...
    case Qt::Key_Shift:		return QStringLiteral("");break;						// Shift
