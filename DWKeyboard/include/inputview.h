...
class DWKEYBOARDSHARED_EXPORT KeyBoardData : public QObjectUserData{
public:
...
class DWKEYBOARDSHARED_EXPORT InputDialogView : public QWidget
{
	Q_OBJECT
public:
...
private:
    ...
    QColor m_btnTxtHoverClr;    // 按钮字体Hover颜色
    QColor m_btnTxtPressClr;    // 按钮字体按下颜色
